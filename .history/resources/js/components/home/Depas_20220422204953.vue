  ...
  <div class="">
    ...
    <div class="flex flex-col md:flex-row flex-wrap gap-5">
      <div class="flex-auto w-full md:w-32">
        <DepaItem url="/image/web/dep/depa1.jpg" text="Punta hermosa 1"></DepaItem>
      </div>
      <div class="flex-auto w-full md:w-32">
        <DepaItem url="/image/web/dep/depa2.jpg" text="Punta hermosa 2"></DepaItem>
      </div>
      <div class="flex-auto w-full md:w-32">
        <DepaItem url="/image/web/dep/depa3.jpg" text="Punta hermosa 3"></DepaItem>
      </div>
    </div>
