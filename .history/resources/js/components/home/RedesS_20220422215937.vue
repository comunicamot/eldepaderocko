    ...
    <div class="flex flex-col md:flex-row gap-14">
      <template v-for="(item,index) in 3" :key="index">
        <div class="w-full md:w-4/12">
           ...
           <iframe allowtransparency="true" frameborder="0" height="710" scrolling="no" data-src="https://www.instagram.com/eldepaderocko/embed/" width="612" class="lazyload"></iframe>
