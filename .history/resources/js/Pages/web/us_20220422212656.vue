...
<div class="container">
      ...
      <div class="row" style="display: flex;     margin-bottom: 45px;
    margin-top: 45px;
    font-size: 23px;">
        <div class="col" style="margin-right: 45px"><strong>Visión:</strong> Ser el portal inmobiliario favorito para pet lovers.</div>
        <div class="col"><strong>Misión:</strong> Que todos los lugares posibles en el mundo sean pet friendly.</div>
      </div>
 </div>
