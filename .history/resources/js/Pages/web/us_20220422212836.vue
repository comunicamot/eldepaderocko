    ...
    <div class="w-full trajectory text-white">
      ...
      <div class="flex text-white w-3/4 justify-between py-5">
        <div class="flex flex-col items-center justify-center">
          ...
          <div><span class="trajectory_number">25k+ RockoFriends</span></div>
          <div>name</div>
        </div>
        <div class="flex flex-col items-center justify-center">
          <div>
          ...
          <div><span class="trajectory_number">3 Depas</span></div>
          <div>name</div>
        </div>
        <div class="flex flex-col items-center justify-center">
          <div>
          ...
          <div><span class="trajectory_number">10 Rockopoints</span></div>
          <div>name</div>
        </div>
        <div class="flex flex-col items-center justify-center">
          <div>
          ...
          <div><span class="trajectory_number">10 Beneficios</span></div>
          <div>name</div>
        </div>
      </div>
    </div>
